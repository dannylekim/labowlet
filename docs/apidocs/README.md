# Labowlet OpenAPI Specification
[![Build Status](https://travis-ci.org/dannylekim/labowletApiDoc.svg?branch=master)](https://travis-ci.org/dannylekim/labowletApiDoc)
...
6. If you did everything correct, https://dannylekim.github.io/labowletApiDoc/ will lead to your new docs
...
- Documentation(ReDoc): https://dannylekim.github.io/labowletApiDoc/
- SwaggerUI: https://dannylekim.github.io/labowletApiDoc/swagger-ui/
- Look full spec:
    + JSON https://dannylekim.github.io/labowletApiDoc/swagger.json
    + YAML https://dannylekim.github.io/labowletApiDoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://dannylekim.github.io/labowletApiDoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://dannylekim.github.io/labowletApiDoc/ with url from the message: `Server started <url>`
